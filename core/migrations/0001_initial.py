    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['post', 'reaction_type'], name='core_reacti_post_id_c38b9c_idx'), models.Index(fields=['user', 'created_at'], name='core_reacti_user_id_31a201_idx')],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['user', 'contact_type', 'is_primary'], name='core_contac_user_id_e9744d_idx'),
        ),
        ...
        migrations.AddIndex(
            model_name='address',
            index=models.Index(fields=['user', 'is_primary'], name='core_addres_user_id_75f14a_idx'),
        ),
        migrations.AddIndex(
            model_name='address',
            index=models.Index(fields=['city', 'state', 'country'], name='core_addres_city_80b6d2_idx'),
        ),
    ]
