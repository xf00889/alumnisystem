...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        PAGE_SEO_DATA = [
            ...
            {
                'page_path': '/news/',
                'meta_title': 'Latest News - NORSU Alumni Updates and Announcements',
                'meta_description': 'Stay informed with the latest news, updates, and important announcements from the NORSU Alumni Network and university community.',
                'meta_keywords': 'NORSU news, alumni news, university updates, announcements, latest news, NORSU updates',
                'sitemap_priority': 0.8,
                'sitemap_changefreq': 'daily',
                'is_active': True,
            },
            ...
            {
                'page_path': '/jobs/careers/',
                'meta_title': 'Career Opportunities - Find Jobs with NORSU Alumni',
                'meta_description': 'Discover exciting career opportunities and job postings from NORSU alumni network. Browse featured jobs and find your next career move today.',
                'meta_keywords': 'NORSU careers, job opportunities, alumni jobs, career board, job listings, employment opportunities',
                'sitemap_priority': 0.8,
                'sitemap_changefreq': 'daily',
                'is_active': True,
            },
            ...
            {
                'page_path': '/news/',
                'meta_title': 'Latest News - NORSU Alumni Network Updates and Stories',
                'meta_description': 'Stay updated with latest news and stories from NORSU Alumni Network. Read about alumni achievements, university updates, and community events happening now.',
                'meta_keywords': 'NORSU news, alumni news, university updates, alumni stories, NORSU announcements, alumni achievements',
                'sitemap_priority': 0.7,
                'sitemap_changefreq': 'daily',
                'is_active': True,
            },
            {
                'page_path': '/landing/events/',
                'meta_title': 'Upcoming Events - NORSU Alumni Gatherings and Activities',
                'meta_description': 'Discover upcoming NORSU alumni events, reunions, and networking sessions. Join us for memorable experiences and reconnect with fellow NORSU graduates today.',
                'meta_keywords': 'NORSU events, alumni events, upcoming events, alumni reunions, networking events, alumni gatherings',
                'sitemap_priority': 0.7,
                'sitemap_changefreq': 'weekly',
                'is_active': True,
            },
            {
                'page_path': '/landing/announcements/',
                'meta_title': 'Announcements - Important Updates for NORSU Alumni',
                'meta_description': 'Read important announcements and updates for NORSU alumni. Stay informed about policy changes, new programs, and opportunities within the alumni network.',
                'meta_keywords': 'NORSU announcements, alumni announcements, important updates, alumni news, policy updates, program announcements',
                'sitemap_priority': 0.7,
                'sitemap_changefreq': 'weekly',
                'is_active': True,
            },
