    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('career_significance', models.CharField(choices=[('REGULAR', 'Regular Position'), ('PROMOTION', 'Promotion'), ('LATERAL', 'Lateral Move'), ('NEW_ROLE', 'New Role'), ('COMPANY_CHANGE', 'Company Change')], default='REGULAR', max_length=20)),
