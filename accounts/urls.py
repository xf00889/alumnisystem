...
urlpatterns = [
    ...
    path('admin/remove-mentor/<int:mentor_id>/', views.remove_mentor, name='remove_mentor'),
    path('admin/reactivate-mentor/<int:mentor_id>/', views.reactivate_mentor_direct, name='reactivate_mentor_direct'),
    path('admin/review-mentor-applications/', views.review_mentor_applications, name='review_mentor_applications'),
    path('admin/mentor-application/<int:application_id>/detail-modal/', views.mentor_application_detail_modal, name='mentor_application_detail_modal'),
    path('admin/review-mentor-reactivation-requests/', views.review_mentor_reactivation_requests, name='review_mentor_reactivation_requests'),
    path('admin/mentor-reactivation-request/<int:request_id>/detail-modal/', views.mentor_reactivation_request_detail_modal, name='mentor_reactivation_request_detail_modal'),
    path('admin/approve-mentor-reactivation/<int:request_id>/', views.approve_mentor_reactivation, name='approve_mentor_reactivation'),
    path('admin/reject-mentor-reactivation/<int:request_id>/', views.reject_mentor_reactivation, name='reject_mentor_reactivation'),
    path('send-reactivation-code/', views.send_reactivation_verification_code, name='send_reactivation_code'),
    path('verify-reactivation-code/', views.verify_reactivation_code, name='verify_reactivation_code'),
