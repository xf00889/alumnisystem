...
class EventListView(LoginRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        total_events = visible_events.count()
        published_events = visible_events.filter(status='published').count()
        upcoming_count = upcoming_events.count()
        past_events = visible_events.filter(end_date__lt=now).count()
