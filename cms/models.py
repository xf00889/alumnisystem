...
class ContactConfig(TimeStampedModel):
    """
    Model for managing contact information configuration
    """
    # Office Information
    office_name = models.CharField(
        max_length=200,
        default="Negros Oriental State University",
        help_text=_("Office/University name")
    )
    address_line1 = models.CharField(
        max_length=200,
        default="Kagawasan, Ave. Rizal",
        help_text=_("Address line 1")
    )
    address_line2 = models.CharField(
        max_length=200,
        default="Dumaguete City, 6200",
        help_text=_("Address line 2")
    )
    address_line3 = models.CharField(
        max_length=200,
        default="Negros Oriental, Philippines",
        help_text=_("Address line 3")
    )
    ...
    weekday_hours = models.CharField(
        ...
        help_text=_("Weekday office hours")
    )
    saturday_hours = models.CharField(
        max_length=100,
        default="Saturday: 8:00 AM – 12:00 PM",
        help_text=_("Saturday office hours")
    )
    sunday_hours = models.CharField(
        max_length=100,
        default="Sunday: Closed",
        help_text=_("Sunday office hours")
    )
    
    class Meta:
        verbose_name = _('Contact Configuration')
        verbose_name_plural = _('Contact Configuration')

    def __str__(self):
        return f"Contact Config - {self.office_name}"

    @classmethod
    def get_contact_config(cls):
        """Get or create the singleton contact configuration"""
        obj, created = cls.objects.get_or_create(
            defaults={
...
class SocialMediaLink(TimeStampedModel):
    ...
    is_active = models.BooleanField(
        default=True,
        help_text=_("Whether this social media link should be displayed")
    )
